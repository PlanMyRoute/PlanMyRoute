...
router.get(
  `${BASE_PATH}/:id/profile`,
  optionalAuth,
  UserController.getUserProfile,
);
router.post(
  `${BASE_PATH}/:id/upload-profile-image`,
  verifyToken,
  requireSameUser,
...
router.get(
  `${BASE_PATH}/:id/trips/count`,
  verifyToken,
  requireSameUser,
  UserController.getUserTripsCount,
);
router.get(
  `${BASE_PATH}/:id/trips/finished/count`,
  verifyToken,
  requireSameUser,
  UserController.getUserFinishedTripsCount,
);
router.get(
  `${BASE_PATH}/:id/trip/:tripId`,
  verifyToken,
  requireSameUser,
  UserController.getUserTripByTripId,
);

// Preferencias de usuario
router.get(
  `${BASE_PATH}/:id/preferences`,
  verifyToken,
  requireSameUser,
...
router.get(
  ...
  verifyToken,
  requireSameUser,
  UserController.getUserUsageStats,
);
