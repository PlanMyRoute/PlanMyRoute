...
import CustomAlert, {
  AlertAction,
} from "@/components/customElements/CustomAlert";
import {
  MicrotextDark,
  SubtitleMedium,
  ...
  return (
    <>
        ...
        <View className="flex-row items-center">
          <View
            className={`w-10 h-10 rounded-full items-center justify-center mr-3 ${
              isSelected ? "bg-primary-yellow" : "bg-dark-black"
            }`}
          >
            <Ionicons
          ...
          <View className="flex-row items-center gap-2">
            ...
            {!isCreatingTrip &&
              ((!isInTrip && (onEdit || onDelete)) ||
                (isInTrip && canRemove && onRemoveFromTrip)) && (
                <TouchableOpacity
      ...
      <CustomAlert
        ...
        message={
          isInTrip
            ? "¿Deseas eliminar este vehículo del viaje?"
