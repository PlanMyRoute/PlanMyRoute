            ...
            <View className="flex-row justify-between items-start">
              <View className="bg-white rounded-full px-3 py-1.5">
                <MicrotextDark className="text-dark-black text-xs">
                  {formatMonthYear(trip.start_date || trip.end_date)}
                </MicrotextDark>
              </View>
              ...
              {userRole && (
                <View
                  className={`rounded-full px-2.5 py-1 ${
                    userRole === "owner" ? "bg-primary-yellow" : "bg-blue-500"
                  }`}
                >
        ...
        <View className="p-3 border-2 border-neutral-gray/20 rounded-b-3xl bg-white">
          ...
          {userReview ? (
            <View className="flex-row items-center gap-1">
              ...
              <MicrotextDark className="text-dark-black text-xs ml-1">
                Mi reseña
              </MicrotextDark>
            </View>
            ...
            <View className="flex-row items-center gap-1">
              ...
              <MicrotextDark className="text-neutral-gray text-xs">
                Sin reseñas
              </MicrotextDark>
            </View>
          )}
