    ...
    >
      ...
      <Animated.View
        style={[
          ...
          {
            top: birdY.current,
            transform: [{ rotate: rotation }, { scale: logoScale }],
          },
        ]}
      >
        <Logo width={BIRD_SIZE} height={BIRD_SIZE * 0.63} color="#202020" />
      </Animated.View>
      ...
      {gameOver && (
        <View style={styles.gameOverContainer}>
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              style={
                tripCreated ? styles.secondaryButton : styles.restartButton
              }
