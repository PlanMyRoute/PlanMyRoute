  ...
  return (
    <>
      <View className="flex-row items-center justify-between p-4 bg-white rounded-2xl border border-neutral-gray/20">
        ...
        <View className="flex-row items-center gap-2">
          ...
          {role !== "owner" && role !== "pending" && canKick && onKick && (
            <TouchableOpacity
              testID="kick-button"
              accessibilityLabel="Expulsar viajero"
              onPress={onKick}
      ...
      >
        ...
        >
          <View
            className="bg-white rounded-3xl p-6 m-4 w-80"
          ...
          >
            ...
            {pendingRole && pendingRole !== role && (
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <TextRegular className="text-center text-dark-black font-semibold">
                  Confirmar cambio
                </TextRegular>
              </TouchableOpacity>
            )}
