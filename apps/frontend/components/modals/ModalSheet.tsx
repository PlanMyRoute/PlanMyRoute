...
import { Animated, KeyboardAvoidingView, Modal, Platform, StyleProp, TouchableOpacity, View, ViewStyle } from 'react-native';
 ...
 *   </ModalSheet>
 */
export function ModalSheet({ visible, onClose, children, minHeight = 400, contentStyle }: ModalSheetProps) {
