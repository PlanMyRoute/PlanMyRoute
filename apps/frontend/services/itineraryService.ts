...
export class ItineraryService {
  ...
  static async createAccommodationStop(
    ...
    try {
      const result = await apiFetch<Stop>(
        `/api/trip/${tripId}/stop/accommodation`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  static async updateStop(
    ...
    try {
      ...
      if (
        !(error as Error)?.message?.includes("Origen") &&
  ...
  static async updateActivityStop(
    ...
    try {
      const result = await apiFetch<Stop>(
        `/api/trip/${tripId}/stop/activity/${stopId}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
  ...
  static async updateAccommodationStop(
    ...
    try {
      const result = await apiFetch<Stop>(
        `/api/trip/${tripId}/stop/accommodation/${stopId}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
  ...
  static async updateRefuelStop(
    ...
    try {
      const result = await apiFetch<Stop>(
        `/api/trip/${tripId}/stop/refuel/${stopId}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
  ...
  static async getTripItinerary(
    ...
    try {
      return await apiFetch<Array<Route & { stops: Stop[] }>>(
  ...
  static async uploadReservationFile(
    ...
    try {
      ...
      const result = await apiFetch<{
        data: { id: string; path: string; url: string };
