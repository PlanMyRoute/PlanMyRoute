...
const GOOGLE_PLAY_URL =
  "https://play.google.com/store/apps/details?id=com.planmyroute";
...
export default function WelcomeScreen() {
  ...
  useEffect(() => {
    ...
    /**
     * HACK: Solución para un problema de renderizado en React Native Web.
     * Sin este workaround, algunos elementos (como las tarjetas de características)
     * no se pintan correctamente tras el montaje inicial del componente.
     * Se fuerza un repaint mediante un evento resize y un ciclo de opacidad.
     * Puede eliminarse cuando React Native Web resuelva el bug de layout inicial.
     */
    if (Platform.OS === "web") {
      setTimeout(() => {
      ...
      <SafeAreaView>
        ...
        >
          ...
          >
            ...
            <Animated.View
              entering={SlideInLeft.delay(800).duration(800).springify()}
            >
              <LinearGradient
                colors={["#FFD54D", "#FFC107"]}
                start={{ x: 0, y: 0 }}
              ...
              >
                <Text style={[styles.heroTitleWhite, { color: "#202020" }]}>
                  Aventura
                </Text>
              </LinearGradient>
            </Animated.View>
            ...
            >
              Planifica viajes increíbles con inteligencia artificial. Colabora
              con amigos, gestiona paradas y costes. Todo en una app intuitiva.
            </Animated.Text>
              ...
              <Link href="/(auth)/register" asChild>
                <Pressable>
                  ...
                  >
                    ...
                    <Text style={[styles.ctaButtonText, { color: "#202020" }]}>
                      Comenzar Gratis
                    </Text>
                  </LinearGradient>
                </Pressable>
              ...
              >
                ...
                <View style={styles.featureImageContainer}>
                  <Image
                    ...
                    onError={() =>
                      console.log(`Error loading image: ${feature.image}`)
                    }
                  />
        ...
        >
          ...
          <Text style={styles.sectionTitleWhite}>4 Pasos Simples</Text>
          ...
          <View style={styles.stepsContainer}>
            {steps.map((step, index) => (
              <Animated.View key={index} style={styles.stepCard}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionTitle}>Lo que Dicen</Text>
          <Text style={styles.sectionSubtitle}>
          ...
          <View style={styles.testimonialsContainer}>
            {testimonials.map((testimonial, index) => (
              <Animated.View key={index} style={styles.testimonialCard}>
        ...
        <View style={styles.premiumSection}>
          ...
          <Text style={styles.sectionTitle}>Lleva tus Viajes Más Lejos</Text>
          <Text style={styles.sectionSubtitle}>
          ...
          <View style={styles.premiumGrid}>
            <View style={styles.premiumCard}>
              ...
              <Text style={styles.premiumDescription}>
                Genera tantos viajes automáticos como quieras con inteligencia
                artificial avanzada
              </Text>
            </View>
        ...
        <View style={styles.downloadSection}>
          ...
          >
            <Text style={[styles.downloadTitleWhite, { color: "#202020" }]}>
              Contigo
            </Text>
          </LinearGradient>
          <Text style={styles.sectionSubtitle}>
          ...
          <Link href="/(auth)/register" asChild>
            <Pressable>
              <View style={styles.finalCtaButton}>
                <Text style={[styles.finalCtaButtonText, { color: "#202020" }]}>
                  Comenzar Gratis
                </Text>
            ...
            <View style={styles.footerBrand}>
              ...
              <View style={styles.socialLinks}>
                <Pressable
                  ...
                  onPress={() =>
                    Linking.openURL("https://www.instagram.com/planmyroute.ai/")
                  }
                >
                ...
                <Pressable
                  style={styles.socialButton}
                  onPress={() =>
                    Linking.openURL("https://www.tiktok.com/@planmyroute")
                  }
                >
