...
/**
 * Hook para gestionar las paradas intermedias del wizard: agregar, eliminar, actualizar, reordenar e inicializar desde borrador.
 * @returns Lista de paradas intermedias y funciones de gestión
 */
export function useTripIntermediateStops() {
  ...
  const updateStop = (
    id: string,
    updates: Partial<Omit<IntermediateStop, "id">>,
  ) => {
    setIntermediateStops((prev) =>
